...
public class ImageManager {
    ...
    public void loadImage(Context context, Object path, ImageView targetImageView) {
        Glide.with(context).load(path).placeholder(R.mipmap.placeholder).error(R.mipmap.notfound).centerCrop().into(targetImageView);
    }
    ...
    public void loadImage(Context context, Object path, ImageView targetImageView, Transformation transformation) {
        Glide.with(context).load(path).bitmapTransform(transformation).placeholder(R.mipmap.placeholder).error(R.mipmap.placeholder).centerCrop().into(targetImageView);
    }
