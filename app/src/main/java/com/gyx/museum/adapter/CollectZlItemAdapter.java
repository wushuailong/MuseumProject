...
public class CollectZlItemAdapter extends BaseQuickAdapter<String> {
    public CollectZlItemAdapter(List<String> list) {
        super(R.layout.activity_my_collect_zp_item,list);
    }
    @Override
