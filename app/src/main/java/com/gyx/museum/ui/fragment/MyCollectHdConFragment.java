...
public class MyCollectHdConFragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener,SwipeRefreshLayout.OnRefreshListener{
    ...
    //MyAdapter myAdapter;
    public static MyCollectHdConFragment newInstance() {
        MyCollectHdConFragment fragment = new MyCollectHdConFragment();
