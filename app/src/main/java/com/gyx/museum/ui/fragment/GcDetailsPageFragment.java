...
import com.gyx.museum.ui.activity.ImagePagerActivity;
...
public class GcDetailsPageFragment extends BaseFragment {
    ...
    public static GcDetailsPageFragment newInstance() {
        GcDetailsPageFragment fragment = new GcDetailsPageFragment();
        return fragment;
    }
    @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.collect_img:
                ...
                collectImg.startAnimation(AnimationUtils.loadAnimation(mContext, R.anim.collect_anim));
                break;
            case R.id.other_img:
                break;
            case R.id.det_img:
                ...
                detfdImg.startAnimation(AnimationUtils.loadAnimation(mContext,R.anim.bwg_img_anim_out));
            ...
            case R.id.detfd_img:
                ...
                detfdImg.startAnimation(AnimationUtils.loadAnimation(mContext,R.anim.bwg_img_anim_in));
                break;
            ...
            case R.id.details_img://细节
                ...
                urls2.add("aaaa");
                urls2.add("33");
                Intent intent2 = new Intent(mContext, ImagePagerActivity.class);
                // 图片url,为了演示这里使用常量，一般从数据库中或网络中获取
