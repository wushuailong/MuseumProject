...
import com.gyx.museum.adapter.CollectHdItemAdapter;
...
public class MyCollectZlConFragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener,SwipeRefreshLayout.OnRefreshListener{
    @BindView(R.id.rv_list)
    RecyclerView recyclerView;
    @BindView(R.id.swipeLayout)
    SwipeRefreshLayout swipeRefreshLayout;
    CollectHdItemAdapter collectItemAdapter;
    List<String> list = new ArrayList<>();
    //MyAdapter myAdapter;
    public static MyCollectZlConFragment newInstance() {
        MyCollectZlConFragment fragment = new MyCollectZlConFragment();
  ...
  /*      myAdapter = new MyAdapter(mContext,getMenuActive());
        ...
        collectItemAdapter = new CollectHdItemAdapter(getMenuActive());
        ...
        collectItemAdapter.setOnDelListener(new CollectHdItemAdapter.onSwipeListener() {
            @Override
